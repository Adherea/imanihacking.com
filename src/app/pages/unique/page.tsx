...
function Page() {
  return (
    <section>
      ...
      <div className="py-10">
        <h1 className="border-b-2 border-[#0E9AC5] w-fit mx-auto text-3xl font-medium">Our Uniqueness</h1>

        <div className="py-14 px-8">
          <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
            <div>
              <h1 className="py-5 text-2xl md:text-3xl">Global Empowerment</h1>
              <p className="max-w-xl text-xl md:text-lg">
          ...
          <div className="max-w-7xl mx-auto  flex md:flex-col-reverse py-16 lg:flex-row flex-col-reverse items-center justify-between">
            <div>
              <h1 className="py-5 text-2xl md:text-3xl">Career Support</h1>
              <p className="max-w-xl text-xl md:text-lg">
          ...
          <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
            <div>
              <h1 className="py-5 text-2xl md:text-3xl">Talent Development</h1>
              <p className="max-w-xl text-xl md:text-lg">
                ...
                boosting their confidence. This model aims to address the employment needs of young people in emerging countries while resolving Japan IT talent shortage.
              </p>
            </div>
