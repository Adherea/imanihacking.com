...
function Page() {
  return (
    <section>
      ...
      <div className="px-9">
        <h1 className="text-center text-2xl md:text-3xl font-semibold py-10">Contents</h1>

        <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">Video Learning Session</h1>
            <p className="max-w-xl md:text-xl">Students can select video courses corresponding to their current levels.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex md:flex-col-reverse py-14 lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">Mentoring Session</h1>
            <p className="max-w-xl md:text-xl">Students meet with mentors to ask questions about the course content and receive guidance on their future plans.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">Lesson Sessions</h1>
            <p className="max-w-xl md:text-xl">Students enrolled in the same course participate in thematic online sessions covering topics such as technology, soft skills, projects, and engage in group discussions.</p>
          </div>
      ...
      <div className="w-fit mx-auto py-20 px-8">
        <h1 className="text-center text-xl md:text-3xl py-16">Our Training process</h1>
        <Image src={training} alt="training.png" width={900} />

        <h1 className="py-24 text-center text-xl md:text-3xl font-semibold">Bootcamp course schedule</h1>
        <table className="min-w-full border border-gray-300">
          ...
          <tbody className="text-center">
            ...
            <tr>
              ...
              <td>Decide which course and make a group /Allocate each mentor /Distribute and Sign Enrollment Agreement</td>
            </tr>
            <tr>
              <th scope="row" className="border border-gray-300 px-4 py-2">
                5.
            ...
            <tr>
              ...
              <td className="border border-gray-300 px-4 py-2">Giving a certification /disscuss to join the real project as a freelancer.</td>
            </tr>
          </tbody>
        </table>
      </div>
