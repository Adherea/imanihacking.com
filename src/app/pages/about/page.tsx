...
import { Ephesis, Iceberg } from "@next/font/google";

const ephesis = Ephesis({
  subsets: ["latin"], // bisa ditambah subset lain sesuai kebutuhan
  weight: ["400"], // sesuaikan dengan weight yang dibutuhkan
});
  ...
  return (
    <section className="bg-[#F8F8F8]">
      ...
      <div className="max-w-7xl mx-auto py-10">
        <h1 className={`${iceberg.className} text-center py-7 text-5xl font-semibold `}>History</h1>
        ...
        <div className="flex lg:flex-row-reverse flex-col px-8 items-center gap-5 justify-between py-12">
          ...
          <div className="">
            <h1 className={`${ephesis.className} py-7 text-6xl font-semibold `}>Global growth</h1>
